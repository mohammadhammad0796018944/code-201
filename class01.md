...
Extra Markup :
 ...
 (Links to an external site.)DOCTYPE
stands for Document Type Declaration Tell the browser what version of html we use , and must be begin with it for html5 ,we use it !DOCTYPE html but it's not considered an element or html tag and every version of html has own DOCTYPE
 ...
 (Links to an external site.)Comments in HTML :
...
<!-- comments parts -->
 ...
 (Links to an external site.)ID Attribute :
id attribute must Unique for styling just one element in html and should be starting # sign and the name of id then call it in youe element <p id="the name of class"> like that .
 ...
 (Links to an external site.)CLASS Attribute :
...
1. <article> element specifies independent, self-contained content.
2. <aside> element defines some content aside from the content it is placed in (like a sidebar).
3. <details> tag Defines additional details that the user can view or hide
4. <header> element represents a container for introductory content or a set of navigational links.
5. <footer> element defines a footer for a document or section.
6. <nav> element defines a set of navigation links.
7. <figure> tag specifies self-contained content, like illustrations, diagrams, photos, code listings
8. <figcaption> tag defines a caption for a figure element. The figcaption element can be placed as the first or as the last child of a figure element.
9. <main> tag Specifies the main content of a document
10. <mark> tag Defines marked/highlighted text
11. <section> tag Defines a section in a document
12. <summary> tag Defines a visible heading for a details element
13. <time> tag Defines a date/time
 (Links to an external site.)Process & Design :
SITE MAP

# (Links to an external site.)What is a sitemap ?
...
# (Links to an external site.)What is a wireframe ?
...
Finally, make sure that your website has a simple user interface, easy to use and this is what the user needs .
 ...
 # javascript
![javascript](https://miro.medium.com/max/6000/0*koVK62DU2I-AVeVg)
...
basic programming concepts Learning the language itself Becoming familiar with how it is applied
...
# How to use Object and Methods ? this ome line of javaScript shows how to use object and methods programming refer to this as calling a method of an oblect. Ex :

 document.write("") the document object represents the entire web page. the wrire() method orFunction of the document object allows new content to be weitten into the page. and we can add html element in this method
